...
@section('content')
    <div class="max-w-4xl mx-auto p-6 mt-4 mb-3 bg-white shadow-lg rounded-lg">
        ...
        <form action="" method="POST">
            ...
            <div id="items-container">
                <div class="luggage-item mb-6 p-4 bg-gray-100 rounded-lg">
                    ...
                    <div class="mb-4">
                        <label for="luggage_name_0" class="block text-sm font-medium text-gray-700">Luggage Name</label>
                        <input type="text" id="luggage_name_0" name="items[0][luggage_name]" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>
                    <div class="mb-4">
    ...
    <script>
        ...
        <div class="luggage-item mb-6 p-4 bg-gray-100 rounded-lg">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="luggage_name_${index}" name="items[${index}][luggage_name]" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            </div>
            <div class="mb-4">
