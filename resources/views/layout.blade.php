...
<nav class="bg-blue-600 p-5">
    <div class="container mx-auto flex justify-between items-center">
        <!-- Logo -->
        <a href="#" class="text-white text-lg font-bold">Luggage Malawi Airline</a>
        ...
        <div class="hidden lg:flex lg:items-center w-full lg:w-auto" id="navbar-menu">
            <ul class="lg:flex lg:space-x-4 text-center lg:text-left">
                ...
                <li>
                    <a href="" class="text-white block px-4 py-2 font-bold">View Luggages</a>
                </li>
                ...
                <li>
                    <a href="{{ route('dashboard') }}" class="text-white block px-4 py-2 font-bold">Login</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="lg:hidden hidden flex flex-col items-center mt-4 space-y-2" id="navbar-links">
        <ul class="text-white text-center space-y-2">
            <li>
                <a href="#" class="block px-4 py-2 font-bold">Register Customers</a>
            </li>
            <li>
                <a href="#" class="block px-4 py-2 font-bold">View Luggage</a>
            </li>
            <li>
                <a href="#" class="block px-4 py-2 font-bold">Track Luggage</a>
            </li>
            <li>
...
<footer class="text-white py-8 bg-gray-500">
    <div class="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mb-6 md:mb-0 text-center md:text-left">
            ...
            <p class="mt-2 text-sm">Fly with us for a memorable and comfortable journey. Your satisfaction is our
                priority.</p>
        </div>
        <!-- Navigation Links -->
