        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="enquiries.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-bullhorn text-lg dark"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="services.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-concierge-bell text-white"></i>
...
<!--            </div>-->
<!--        </div>-->
        <a class="btn bg-gradient-primary mt-5 w-100" href="logout.php">Logout</a>
    </div>
</aside>